<div class="search">
    ...
    <form action="">
      ...
      <input
        type="text"
        placeholder="Search any event offer, with specific location"
      />
      <a href="#" class="filter">
          Filter
          <svg width="34" height="23" viewBox="0 0 34 23" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M13.1813 23H20.7134V19.1667H13.1813V23ZM0 0V3.83333H33.8947V0H0ZM5.64912 13.4167H28.2456V9.58333H5.64912V13.4167Z" fill="#31334E"/>
          </svg>
      </a>
    </form>
</div>
