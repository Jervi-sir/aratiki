...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('offers', function (Blueprint $table) {
            ...
            $table->string('uuid_for_images')->unique();        //must be same as uuid but without dash -
            ...
            $table->string('duration');         //must be in english

            /*--[ tickets ]--*/
            $table->string('payment_type_name'); 
            //$table->longText('tickets'); //a json for type tickets [type, price, total, ticket_left]
            ...
            /*--[ of search data ]--*/
            $table->longText('for_search');     //fr, en, ar in json
